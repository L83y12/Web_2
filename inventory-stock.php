...
<body class="admin-body">
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            <a href="dashboard.php"><img src="../assets/images/icons/home.png" alt="Trang chủ"><span>Trang
                    chủ</span></a>
            <a href="inventory.php" class="active"><img src="../assets/images/icons/inventory-alt.png"
                    alt="Quản lý tồn kho"><span>Quản lý tồn kho</span></a>
            <div class="sidebar-footer"><a href="logout.php" class="logout-btn"><span>Đăng xuất</span></a></div>
        </nav>
    </aside>
